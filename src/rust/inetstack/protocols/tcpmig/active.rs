...
impl ActiveMigration {
    ...
    pub fn process_packet(&mut self, ipv4_hdr: &Ipv4Header, hdr: TcpMigHeader, buf: DemiBuffer, ctx: TcpMigContext) -> Result<TcpmigReceiveStatus, Fail> {
        #[inline]
    ...
    pub fn take_buffered_packets(&mut self) -> Vec<(TcpHeader, DemiBuffer)> {
